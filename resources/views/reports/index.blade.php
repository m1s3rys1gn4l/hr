...
<div class="card">
    ...
    <form method="GET" action="{{ route('reports.index') }}" style="margin-top: 12px; display: flex; gap: 10px; flex-wrap: wrap; align-items: flex-end;">
        <div>
        ...
        <div style="display: flex; gap: 8px; margin-left: auto; padding-bottom: 1px;">
            <button type="submit" style="background: #2563eb; color: #fff; border: none; border-radius: 4px; padding: 7px 14px; cursor: pointer; font-size: 13px; font-weight: 600;">Filter</button>
            <a href="{{ route('reports.index') }}" style="background: #6b7280; color: #fff; border: none; border-radius: 4px; padding: 7px 14px; text-decoration: none; display: inline-block; font-size: 13px; font-weight: 600;">Reset</a>
        </div>
    </form>
</div>
